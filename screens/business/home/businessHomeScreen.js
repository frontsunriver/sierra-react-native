...
const jobList = [
  {
    id: "1",
    sourceLogo: require("../../../assets/images/jobs/job9.png"),
...
const BusinessHomeScreen = ({ navigation, setShouldClosePanel }) => {
  ...
  function profileBanner() {
    return (
      <ImageBackground
        source={require("../../../assets/images/users/business_banner.jpg")}
        style={{
          width: screenWidth,
      ...
      >
        <View style={styles.outerRing}>
          <Image
            source={require("../../../assets/images/business_avatars/1.png")}
            style={styles.avatar}
          />
        </View>
    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={styles.actionBar}>
          <TouchableOpacity style={[styles.actionIcon, styles.activeAction]}>
